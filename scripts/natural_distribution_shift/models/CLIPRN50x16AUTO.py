...
def classifier_loader():
    model, _ = clip.load("RN50x16", jit=False)
    return model
...
registry.add_model(
    Model(
        name = 'CLIPRN50x16AUTO',
        transform =  StandardTransform(img_resize_size=384, img_crop_size=384),
