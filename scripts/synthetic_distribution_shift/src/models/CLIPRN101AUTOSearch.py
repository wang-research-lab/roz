...
all_prompts = True
sample_p = 0
prompts_id_file = '/home/chenyangyi/RobustVisionFeatures/AutoPrompt/RN101_kreserved40.log'
...
def preprocess(model):
    ...
    print('template number: ', len(promptids_li))
...
registry.add_model(
    Model(
        name = 'CLIPRN101AUTOSearch',
        transform =  StandardTransform(img_resize_size=224, img_crop_size=224),
